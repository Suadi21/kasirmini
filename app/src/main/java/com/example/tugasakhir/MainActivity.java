...
//aplikasi ini saya mengikuti tutorial di internet
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Kasir mini");
        ...
        btnproses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (total >=200000){
                    txtbonus.setText("Bonus : Gula");
                } else if (total >=50000){
                    txtbonus.setText("Bonus : Minyak");
                } else  if (total >=40000){
                    txtbonus.setText("Bonus : Beras");
                } else {
